(function() {
    ...
    function stateConfig($stateProvider) {
        ...
        .state('comentario.admin', {
            parent: 'entity',
            url: '/comentariosAdmin?page&sort&search',
            data: {
                authorities: ['ROLE_USER'],
                pageTitle: 'ecofruitApp.comentario.home.title'
            },
            views: {
                'content@': {
                    templateUrl: 'app/entities/comentario/comentariosAdmin.html',
                    controller: 'ComentarioController',
                    controllerAs: 'vm'
                }
            },
        ...
        .state('comentario.receta', {
            parent: 'entity',
            url: '/comentarioReceta?page&sort&search',
            data: {
                authorities: ['ROLE_USER'],
                pageTitle: 'ecofruitApp.comentario.home.title'
            },
            views: {
                'content@': {
                    templateUrl: 'app/entities/comentario/comentariosReceta.html',
                    controller: 'ComentarioController',
                    controllerAs: 'vm'
                }
            },
